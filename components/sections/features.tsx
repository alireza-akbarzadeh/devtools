    ...
    <section id="features" className="py-20 md:py-24">
      <div className="container max-w-6xl space-y-6">
        <HeaderSection
          ...
          subtitleClassName="text-white/70 text-lg text-center mt-5"
        ...
        <div className="flex flex-col gap-5">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="group relative flex items-center gap-4 overflow-hidden rounded-lg border border-white/20 bg-background p-4"
            >
              <div
